...
**Now:** Shipping an [eight-organ orchestration system](https://github.com/meta-organvm) across <!-- v:total_repos -->113<!-- /v --> repos, <!-- v:total_organs -->8<!-- /v --> orgs, and <!-- v:total_words_short -->404K+<!-- /v --> words of public documentation.
